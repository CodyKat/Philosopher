...
/*   Updated: 2022/07/13 19:40:32 by jaemjeon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_my_right_fork(t_philo_info *info)
{
	...
	info->union_info->fork_status[info->right_fork_id] = LOCK;
...
void	get_my_left_fork(t_philo_info *info)
{
	...
	info->union_info->fork_status[info->left_fork_id] = LOCK;
...
void	philo_eat(t_philo_info *info)
{
	...
	info->union_info->fork_status[info->left_fork_id] = UNLOCK;
	info->union_info->fork_status[info->right_fork_id] = UNLOCK;
